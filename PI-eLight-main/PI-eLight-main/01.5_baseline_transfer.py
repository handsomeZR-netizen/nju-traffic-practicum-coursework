...
parser.add_argument('--model', type=str, default='MPLight', help='[CoLight, EcoLight, FRAP, MPLight, PiRule]')
...
parser.add_argument('--target', type=str, default='Hangzhou1', help='[Hangzhou1, Hangzhou2, Hangzhou3, Manhattan, Atlanta, Jinan, LosAngeles]')
...
def run_an_experiment(inter_name, flow_idx, seed):
    ...
    for idx in range(target_env.n):
        ...
        copy_model_params(env.n_agent[0].network_local, agent.network_local)  # 迁移通常是杭州迁到其他地区, 杭州只有一个信号灯
        # 把能复制的参数复制过来
